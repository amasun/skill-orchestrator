...
- **v3.2.5 (2026-07-28)**：支持云端/NPM 同名技能热覆盖与自动更新。
- **v3.2.4 (2026-07-28)**：支持在 `package.json` 中持久化记录项目历史技能清单，实现 1 键精准还原与零死角防护。
- **v3.2.0 (2026-07-28)**：实现真实 IDE 动态扫描与 `vault_registry.json` 出处追踪，支持 100% 物理原路径精确还原。
