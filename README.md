...
3. **全网多云端源与本地注册表无缝级联**：支持 Vercel、Upskill 安全库、GitHub 官方组织仓库 (`owner/repo`)、国内极速 CDN 及团队私有库。
...
- **v2.2.8 (2026-07-28)**：优化“功能特点”表述，将过于限定的数字改为“全网多云端源与本地注册表无缝级联”，表述更加自然地道。
- **v2.2.7 (2026-07-28)**：泛化第 3 优先级目录表述为 `~/.<ide-or-agent>/skills/`。
