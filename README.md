...
> **版本**：v2.0.0 (工业级全模块版)  
> **核心原则**：依赖自动推断 · 首轮自动透明汇报 · Prompt 缓存锚点 · 熔断降级保障 · Token 预算实时诊断仪表盘  

---

## 📢 首轮对话自动汇报规范 (Proactive Telemetry Report Protocol)

在任何新项目/新工作区中，当需求定稿或首轮技能调配完成后，AI 会在回复末尾**自动透明输出【本项目技能与 Token 健康度汇报卡】**，无需用户手动询问：
...
| **可观察性与监控** | 无法感知技能占用的具体 Token 权重 | **Token Telemetry 诊断仪表盘** (可视健康度柱状输出 + 首轮自动汇报) |
...
flowchart TD
    ...
    subgraph LIFECYCLE["项目生命周期全流程"]
        ...
        P2["Phase 2: 级联匹配与依赖推断<br>・Auto-Infer: 自动扫 package.json<br>・1st 优先检索: 本地私有冷归档<br>・2nd 熔断保护拉取: Vercel 云端库<br>・首轮自动输出 Token 健康汇报卡"]:::phaseStyle
...
### Q3: 每个新项目完成技能装载后，AI 会自动汇报 Token 占用吗？
**答**：会的。新项目需求定稿或首轮技能装载后，AI 会在回复末尾自动附带一张透明的【本项目技能与 Token 健康度汇报卡】，展示装载的技能清单、来源及节省的 Token 百分比。
...
- **v2.0.0 (2026-07-28)**：全面实现 v2.0 工业级四大核心模块，新增首轮对话自动透明汇报机制与自然语言触发映射。
