...
| **首轮汇报** | 技能装载自动通知 | - [ ] 汇报卡排版集中于 CLI 命令行后，清晰易读 |
...
- **v2.0.2 (2026-07-28)**：重构文档排版逻辑，将对话框触发指引收拢放置于开发者命令行工具之后，保持架构逻辑顺畅干炼。
- **v2.0.0 (2026-07-28)**：全面实现 v2.0 工业级四大核心模块。
- **v1.3.1 (2026-07-28)**：修复 GitHub 针对 `<>` 尖括号、`[]` 方括号标签解析的 Mermaid 语法兼容问题。
- **v1.2.0 (2026-07-28)**：增加资产分类防护规范。
- **v1.1.0 (2026-07-28)**：引入 Vercel 云端插件支持。
- **v1.0.0 (2026-07-28)**：初始架构确立。
